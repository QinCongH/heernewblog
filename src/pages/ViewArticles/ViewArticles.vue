<template>
  <div class="view-articles w-90">
    <div :style="{background:isDark?'#2c2c2c':''}" class="breadcrumb flex-h align-center justify-between pd-bt-10 border-b-eee">
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item
          ><a href="javascript:;" :style="{color:isDark?'#fff':'#222'}">{{ title }}</a></el-breadcrumb-item
        >
      </el-breadcrumb>
